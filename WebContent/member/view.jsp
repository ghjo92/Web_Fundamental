					...
					<form class="form-horizontal" role="form" name="f" method="post"
						...
						<div class="form-group">
							<label class="col-form-label" for="id">아이디</label> <input
								type="text" class="form-control" name="id"  value="<%=id %>" id="id"
						...
						<div class="form-group">
							<label for="phone">휴대폰 번호</label> <input type="tel"
								class="form-control" name="phone"  value="<%=phone %>" id="phone" 
              ...
              <div class="form-group text-center">
               ...
               -->
					...
					<div class="text-right">
						<a href="" class="btn btn-outline-primary" id=modifyMember>수정</a>
						<a href="" class="btn btn-outline-danger" id=deleteMember>삭제</a> <a
							href="list.jsp?page=<%=cPage %>" class="btn btn-outline-success">리스트</a>
					</div>
					<script>
					$(function(){
