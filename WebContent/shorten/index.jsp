					...
					<form>
						...
						<div class="form-row d-flex align-items-center">
							...
							<div class="form-group col-md-4">
								<button id="clip_copy" data-clipboard-target="#shortenUrl"
									class="btn btn-info btn-lg btn-block">
									<i class="fa fa-clipboard" aria-hidden="true"></i> Copy to
									clipboard
								</button>
							</div>
						</div>
									...
									$("#refreshNumber").on("click", function(e){										
										...
										$.ajax({
											...
											success : function(json){												
												console.log(json);
												if(json.result=="ok"){
													let shortenUrl = json.shortenUrl;
													$("#shortenUrl").html(shortenUrl);
												}else{
